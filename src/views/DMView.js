...
import { deriveShortRestProcedureSnapshot, SHORT_REST_LOG_ACTION, SHORT_REST_RESPONSE_ACTION } from '../utils/shortRestWorkflow';
...
export default function DMView() {
  ...
  const refreshAll = useCallback(async () => {
    if (!encounterId) return;
    const [enc, comb, states, token, codes, shortRestProcedureLogs] = await Promise.all([
